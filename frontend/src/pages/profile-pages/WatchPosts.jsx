  ...
  return (
    <div className='w-screen min-h-screen bg-black flex justify-center '>
        ...
        <div className='fixed z-30 top-0 w-full max-w-[500px] bg-gray-950 flex gap-8 py-2 px-4'>
            <IoArrowBackSharp onClick={()=> navigate(-1)} className=' hover:bg-gray-900 hover:border-b-[0.3px] hover:scale-105 active:scale-95 border-gray-400 text-3xl rounded-xl cursor-pointer'/>
