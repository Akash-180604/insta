  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        <div className="w-9 h-9 rounded-full  bg-white p-[0.05rem] shrink-0 cursor-pointer mx-2">
        ...
        <div className="h-full w-full px-2 flex-col justify-between">
          ...
          <p className="text-gray-300/90 text-xs">
      ...
      <div className="h-full w-16 px-2 flex-col justify-between">
        <h2 className="text-white font-medium text-sm text-center">
          {shortCount(user?.followers?.length)}
        </h2>
        <p className="text-gray-300 text-xs">Followers</p>
      </div>

          <div onClick={deleteSearchedUsers} className="active:scale-90 hover:scale-110 h-full px-2">
